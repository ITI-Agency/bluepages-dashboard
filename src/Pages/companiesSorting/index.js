  ...
  const getAllCompanies = async (type,cityId=null) => {
    ...
    try {
      ...
      if (
        ...
        // setLoading(false);
        console.log("🚀 ~ file: index.js:85 ~ getAllCompanies ~ sortedCompaniesData:", sortedCompaniesData.length)
  ...
  return (
    <DashboardLayout>
      ...
      <Paper
        ...
        >
          <Form initialValues={initialValues} {...layout} name="control-hooks" form={form}>
            {/* <MDBox sx={style}> */}
            <Grid container spacing={5}>
              ...
              </Grid>
              {
                ...
                label="City"
              >
                <Select placeholder="Select a City" allowClear                 onChange={handleCityChange}
>
                  {cities?.map((city) => (
      ...
      {
        dataSource?.length === 0  || loading ?<div>No Data Yet...</div> :
        <>
