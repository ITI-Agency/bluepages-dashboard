							...
							<Grid item xs={12} sm={6}>
								...
								>
									<MDBox mr={1} className="no-ant-item-margin">
										<Form.Item>
											<Button type="success" className="text-black bg-green-500 hover:bg-green-400 hover:text-black" htmlType="submit">
												تأكيد
											</Button>
										</Form.Item>
									</MDBox>
									<MDButton onClick={() => setOpenSelectModal(false)} variant="text" color="dark">
										<div className="px-4 py-2 text-white bg-blue-500 hover:bg-blue-400 hover:text-white">إلغاء</div>
									</MDButton>
								</MDBox>
							</Grid>
						</Grid>
